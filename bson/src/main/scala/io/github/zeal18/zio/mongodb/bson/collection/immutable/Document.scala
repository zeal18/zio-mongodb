...
import io.github.zeal18.zio.mongodb.bson.codecs.ImmutableDocumentCodec
...
object Document extends SpecificIterableFactory[(String, BsonValue), Document] {
  ...
  implicit val codec: Codec[Document] = ImmutableDocumentCodec()
  ...
  def builder: mutable.Builder[(String, BsonValue), Document] =
