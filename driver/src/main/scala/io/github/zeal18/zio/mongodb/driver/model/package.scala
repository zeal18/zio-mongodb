...
import com.mongodb.client.model.MongoTimeUnit as JMongoTimeUnit
...
package object model {
  ...
  object EstimatedDocumentCountOptions {
    def apply(): EstimatedDocumentCountOptions =
  ...
  object TimeSeriesOptions {
    def apply(timeFieldName: String): TimeSeriesOptions =
      new com.mongodb.client.model.TimeSeriesOptions(timeFieldName)
  }
  ...
  object DeleteManyModel {
    def apply[T](filter: Bson): DeleteManyModel[T] =
      new com.mongodb.client.model.DeleteManyModel[T](filter)
  ...
  object DeleteOneModel {
    ...
    /** Construct a new instance.
      ...
      */
    def apply(filter: Bson): DeleteOneModel[Nothing] =
      new com.mongodb.client.model.DeleteOneModel(filter)
  }
