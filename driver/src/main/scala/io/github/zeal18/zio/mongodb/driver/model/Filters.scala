...
object Filters {
  ...
  def lte[TItem](fieldName: String, value: TItem): Bson =
    JFilters.lte(fieldName: String, value: TItem)
  ...
  def `type`(fieldName: String, bsonType: BsonType): Bson =
    JFilters.`type`(fieldName, bsonType)
  ...
  def mod(fieldName: String, divisor: Long, remainder: Long): Bson =
    JFilters.mod(fieldName, divisor, remainder)
  ...
  def text(search: String, textSearchOptions: TextSearchOptions): Bson =
    JFilters.text(search, textSearchOptions)
  ...
  def all[TItem](fieldName: String, values: TItem*): Bson =
    JFilters.all(fieldName, values.toList.asJava)
  ...
  def bitsAllClear(fieldName: String, bitmask: Long): Bson =
    JFilters.bitsAllClear(fieldName, bitmask)
  ...
  def bitsAnyClear(fieldName: String, bitmask: Long): Bson =
    JFilters.bitsAnyClear(fieldName, bitmask)
  ...
  def geoWithin(fieldName: String, geometry: Geometry): Bson =
    JFilters.geoWithin(fieldName, geometry)
  ...
  def geoWithinPolygon(fieldName: String, points: Seq[Seq[Double]]): Bson =
    JFilters.geoWithinPolygon(
      fieldName,
      points.map(_.asInstanceOf[Seq[lang.Double]].asJava).asJava,
    ) // scalafix:ok
  ...
  def geoIntersects(fieldName: String, geometry: Bson): Bson =
    JFilters.geoIntersects(fieldName, geometry)
  ...
  def near(fieldName: String, geometry: Point): Bson =
    JFilters.near(fieldName, geometry, null, null) // scalafix:ok
  ...
  def near(fieldName: String, x: Double, y: Double): Bson =
    JFilters.near(fieldName, x, y, null, null) // scalafix:ok
  ...
  def nearSphere(fieldName: String, geometry: Point): Bson =
    JFilters.nearSphere(fieldName, geometry, null, null) // scalafix:ok
  ...
  def nearSphere(fieldName: String, x: Double, y: Double): Bson =
    JFilters.nearSphere(fieldName, x, y, null, null) // scalafix:ok
  ...
  implicit private class ScalaOptionDoubleToJavaDoubleOrNull(maybeDouble: Option[Double]) {
